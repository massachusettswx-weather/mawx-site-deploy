...
# Per-frame GCS inventory publication is intentionally throttled heavily.
#
# Operational IFS/AIFS publication happens at the completed forecast-hour
# boundary. Re-scanning the cloud inventory every few seconds while thousands
# of regional PNGs are rendering is expensive and adds no value to the site's
# forecast-hour synchronization.
#
# Set WEATHER_FRAME_PROGRESS_INTERVAL explicitly if fine-grained diagnostic
# progress is ever needed.
...
def publish_cycle(
    *,
    ...
    # ========================================================
    # 6. REFRESH 7-DAY MODEL ARCHIVE
    #
    # Do this ONCE after the completed cycle has been fully
    # published. Never run archive discovery from per-frame
    # publication because that would repeatedly scan GCS while
    # a model is disseminating.
    #
    # Archive failure must not invalidate an otherwise
    # successfully published model cycle.
    # ========================================================
