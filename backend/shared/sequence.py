...
def render_regions(
    *,
    ...
    # Use the same shared model-independent balancing policy as
    # instantaneous products.
    #
    # Build a stable product-specific offset.  Unlike Python's hash(),
    # this remains identical across processes and runs.
    product_offset = sum(
        ord(character)
    ...
    for region_name in balanced_regions:
