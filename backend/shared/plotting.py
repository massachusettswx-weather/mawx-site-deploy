...
# ============================================================
# BATCH 7 - SHARED CARTOGRAPHY
# ============================================================
US_DETAIL_REGIONS = {
    "conus", "northeast", "new_england", "mid_atlantic",
    "southeast", "florida", "gulf_coast", "southern_plains",
    "central_plains", "northern_plains", "midwest", "great_lakes",
    "ohio_valley", "rockies", "southwest", "northwest", "california",
}
COUNTY_DETAIL_REGIONS = {
    "northeast", "new_england", "mid_atlantic", "southeast",
    "florida", "gulf_coast", "great_lakes", "ohio_valley",
}
def add_latlon_grid(ax, region_name):
    if region_name in {"global", "arctic", "antarctica", "southern_ocean"}: return
    gl=ax.gridlines(crs=ccrs.PlateCarree(),draw_labels=True,linewidth=0.35,linestyle="--",alpha=0.45,zorder=6)
    gl.top_labels=False; gl.right_labels=False
    gl.xformatter=LONGITUDE_FORMATTER; gl.yformatter=LATITUDE_FORMATTER
    gl.xlabel_style={"size":8}; gl.ylabel_style={"size":8}
def add_counties_if_available(ax, region_name):
    if region_name not in COUNTY_DETAIL_REGIONS: return
    try:
        from metpy.plots import USCOUNTIES
        ax.add_feature(USCOUNTIES.with_scale("20m"),linewidth=0.18,edgecolor="0.45",facecolor="none",alpha=0.55,zorder=5)
    except Exception:
        pass
...
def add_base_map(
    ...
    if region_name in US_DETAIL_REGIONS or region_name == "north_america":
